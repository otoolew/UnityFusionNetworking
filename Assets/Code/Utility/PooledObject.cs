...
namespace Utility
{
    ...
    /// will work just fine since both of these will be reset automatically), you mostly do need to explicitly decide what to reset and when
    ...
    /// pooled objects (it is also called on first instantiation) and only use Awake to setup things that will not change over the life of the object.
    /// </summary>
