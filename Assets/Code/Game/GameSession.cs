...
{
	public class GameSession : ContextBehaviour
	{
		// PUBLIC MEMBERS
		...
		public override void Spawned()
		{
			...
			gameObject.name = $"GameSession{Context.LocalPlayerRef}";
		}
		...
		{
			DebugLogMessage.Log(Color.yellow, $"CharacterSpawned Fusion Event -> {player.Context.ObservedPlayerRef}");
