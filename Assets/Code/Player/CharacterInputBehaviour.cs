...
{
    public class CharacterInputBehaviour : ContextBehaviour, IBeforeUpdate, IBeforeTick
    {
        /// <summary>
        ...
        private void ProcessStandaloneInput()
        {
            ...
            _cachedInput.WeaponButton =
                _renderInput.WeaponButton != 0 ? _renderInput.WeaponButton : _cachedInput.WeaponButton;
        }
        ...
        private Vector3 GetMoveDirection()
        {
            ...
            if (Input.GetKey(KeyCode.W) == true) direction += Vector3.forward;

            if (Input.GetKey(KeyCode.S) == true) direction += Vector3.back;

            if (Input.GetKey(KeyCode.A) == true) direction += Vector3.left;

            if (Input.GetKey(KeyCode.D) == true) direction += Vector3.right;
